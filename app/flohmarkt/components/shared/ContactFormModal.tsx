      ...
      >
        ...
        <div className="bg-[#003366] text-white p-5 rounded-t-xl">
          <div className="flex items-center justify-between">
            <div>
              <h2 className="text-xl font-bold m-0">Kontakt</h2>
              <p className="text-sm opacity-90 m-0 mt-1">{tenantName}</p>
              {eventTitle && (
                <p className="text-xs opacity-75 m-0 mt-1">{eventTitle}</p>
              )}
            </div>
            <button
              onClick={handleClose}
            ...
            <div className="text-center py-8">
              <div className="w-20 h-20 bg-green-100 rounded-full flex items-center justify-center mx-auto mb-4">
                <SuccessIcon
                  ...
                  size={40}
                  strokeWidth={2}
                  aria-label="Erfolgreich gesendet"
                />
              </div>
